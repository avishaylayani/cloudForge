...
( helm install details-app-prod details_app_prod && rm -rf details_app_prod/values.yaml && echo "[+] Production Deployment succeded" && \
 helm install details-app-dev details_app_dev && rm -rf details_app_dev/values.yaml && echo "[+] Dev Deployment succeded" ) || \
